...
./orchestrator --force-clear-db --vanguard-grpc-endpoint=127.0.0.1:4000 --ws --ws.addr=127.0.0.1 --ws.port=7878 --pandora-rpc-endpoint=ws://127.0.0.1:8546 --verbosity=debug
