...
./orchestrator --force-clear-db --vanguard-rpc-endpoint=ws://127.0.0.1:8566 --ws --ws.addr=127.0.0.1 --ws.port=7878 --pandora-rpc-endpoint=ws://127.0.0.1:8546 --verbosity=debug
